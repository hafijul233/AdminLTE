  ...
  Toolbar_createClass(Toolbar, [{
    ...
    value: function initialize() {
      ...
      if (!this.options.toolbar.length) {
        ...
        this.context.invoke('buttons.resources', this.$toolbar, this.options.toolbar);
      }
...
var LinkPopover_LinkPopover = /*#__PURE__*/function () {
  ...
  LinkPopover_createClass(LinkPopover, [{
    ...
    value: function initialize() {
      ...
      this.context.invoke('buttons.resources', $content, this.options.popover.link);
...
var ImagePopover_ImagePopover = /*#__PURE__*/function () {
  ...
  ImagePopover_createClass(ImagePopover, [{
    ...
    value: function initialize() {
      ...
      var $content = this.$popover.find('.popover-content,.note-popover-content');
      this.context.invoke('buttons.resources', $content, this.options.popover.image);
      this.$popover.on('mousedown', function (e) {
        e.preventDefault();
      });
    }
...
var TablePopover_TablePopover = /*#__PURE__*/function () {
  ...
  TablePopover_createClass(TablePopover, [{
    ...
    value: function initialize() {
      ...
      var $content = this.$popover.find('.popover-content,.note-popover-content');
      this.context.invoke('buttons.resources', $content, this.options.popover.table); // [workaround] Disable Firefox's default table editor
  ...
  VideoDialog_createClass(VideoDialog, [{
    ...
    value: function show() {
      ...
      this.showVideoDialog(text).then(function (url) {
        ...
        _this.context.invoke('editor.restoreRange'); // resources node
...
var AirPopover_AirPopover = /*#__PURE__*/function () {
  ...
  AirPopover_createClass(AirPopover, [{
    ...
    value: function initialize() {
      ...
      this.context.invoke('buttons.resources', $content, this.options.popover.air); // disable hiding this popover preemptively by 'summernote.blur' event.

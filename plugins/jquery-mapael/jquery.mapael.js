...
(function (factory) {
    ...
    Mapael.prototype = {
        ...
        drawLink: function (id, xa, ya, xb, yb, elemOptions) {
            ...
            // public(c,d) = public(a,b) (=abDist)
            var abDist = Math.sqrt((xb - xa) * (xb - xa) + (yb - ya) * (yb - ya));

            // Solution for equation public(cd) = sqrt((xd - xc)² + (yd - yc)²)
            // public(c,d)² = (xd - xc)² + (yd - yc)²
            // We assume that public(c,d) = public(a,b)
            // so : (xd - xc)² + (yd - yc)² - public(a,b)² = 0
            // With the factor : (xd - xc)² + (yd - yc)² - (factor*public(a,b))² = 0
            // (xd - xc)² + (acd*xd + bcd - yc)² - (factor*public(a,b))² = 0
            var a = 1 + acd * acd;
